...
'''
    This file runs StructureFromMotion with OpenMVG and then mesh reconstruction with OpenMVS if the --do_MVS argument is passed
...
create_images_SfM_folder(args.base_name, args.extension)
