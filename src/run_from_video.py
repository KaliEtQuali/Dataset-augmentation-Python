...
parser.add_argument("-bn", "--base_name", default="frame", help="Base name of the images that will be created.\
                    Eg if you want the images to be like Tool1.jpg, Tool2.jpg ... then the base name is Tool")
parser.add_argument("-s", "--step", default=5, help="Stide is the step with which the images are gonna be selected\
