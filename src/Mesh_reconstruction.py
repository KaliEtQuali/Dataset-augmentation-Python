...
print("13. Texture mesh with OpenMVS")
pOpenMVS = subprocess.Popen( [os.path.join(OPENMVS_BIN, "TextureMesh"), "-i", "scene_dense_mesh.mvs", "-o", "scene_dense_mesh_textured", "-w", openMVS_output_dir, "--empty-color", str(0)])
pOpenMVS.wait()

#Uncomment if we want the mesh to be refined
print("14. Refine mesh with OpenMVS")
